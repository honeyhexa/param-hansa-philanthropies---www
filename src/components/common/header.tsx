...
export const Header = ({ theme = "dark" }) => (
  <header className="z-100 fixed w-full border border-zinc-500/20 border-t-transparent bg-[#FAFAFA]/80 dark:bg-[#4A1A51] backdrop-blur-lg dark:[#4A1A51]" data-theme={theme}>
    <div className="w-full h-16 m-auto max-w-6xl grid grid-cols-4">
      <Link className="col-start-1 col-span-2 flex flex-row items-center text-[#4A1A51] dark:text-white" href="/">
      ...
      {/* <Link href="/" className="group col-start-3 col-span-1" data-theme={theme}>
