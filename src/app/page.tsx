    ...
    <Page>
      <HeroV0
        ...
        primaryCTA={{
          label: (
            <>
              Explore our values <ArrowRight className="h-8 mr-4" />
            </>
          ),
          href: "/philosophy",
        }}
        secondaryCTA={{
          label: (
            <>
              See our impact <ArrowRight className="h-8 mr-4" />
            </>
          ),
          href: "/work",
        }}
      ...
      <Section>
        <div className="grid grid-cols-4 text-[#4A1A51] ">
          <div className="col-start-3 col-span-2 border-t border-t-zinc-500/20 px-2">
            <p className="bg-[#FAFAFA] pt-8 pb-16 font-schibsted font-semibold tracking-[-0.04em] text-md leading-[1.2] lowercase ">
              Paramhansa Yogananda’s timeless teachings remind us that true
              progress harmonizes the material and the divine. At param hansa
              philanthropies, we channel his wisdom to ensure technology serves
              not just humanity, but the sanctity of life itself.
            </p>
          </div>
